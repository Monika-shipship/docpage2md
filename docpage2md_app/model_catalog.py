...
def get_default_catalog():
    specs = [
        ...
        ModelSpec(
            ...
            supports_vision=True,
            supports_thinking=True,
            price=ModelPrice(2.0, 8.0, 0.4, source="docs/reference-pricing/视觉OCR模型价格整理_2026-06-12.md", note="按 qwen3.7-plus 原价阶梯估算，未扣除限时折扣。"),
            context_tokens=1_000_000,
            max_output_tokens=64_000,
            rpm=30_000,
            tpm=5_000_000,
        ...
        ModelSpec(
            ...
            supports_vision=True,
            supports_thinking=True,
            price=ModelPrice(2.0, 12.0, source="docs/reference-pricing/视觉OCR模型价格整理_2026-06-12.md"),
            context_tokens=1_000_000,
            max_output_tokens=64_000,
            rpm=30_000,
            tpm=5_000_000,
        ...
        ModelSpec(
            ...
            supports_vision=True,
            supports_thinking=True,
            price=ModelPrice(3.0, 18.0, source="docs/reference-pricing/视觉OCR模型价格整理_2026-06-12.md"),
            context_tokens=256_000,
            max_output_tokens=64_000,
        ...
        ModelSpec(
            ...
            supports_vision=True,
            supports_thinking=True,
            price=ModelPrice(0.8, 4.8, source="docs/reference-pricing/视觉OCR模型价格整理_2026-06-12.md"),
            context_tokens=1_000_000,
            max_output_tokens=64_000,
            rpm=30_000,
            tpm=5_000_000,
        ...
        ModelSpec(
            ...
            supports_vision=True,
            supports_thinking=True,
            price=ModelPrice(0.6, 4.8, source="docs/reference-pricing/视觉OCR模型价格整理_2026-06-12.md"),
            context_tokens=256_000,
            max_output_tokens=64_000,
        ...
        ModelSpec(
            ...
            supports_thinking=True,
            price=ModelPrice(0.8, 8.0, source="docs/reference-pricing/价格.md"),
