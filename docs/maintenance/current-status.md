...
- Third-party model management can now directly accept an API Key in the GUI, save it to local ignored secrets / Windows user env / Windows Credential Manager, and still keep `third_party_models.json` free of plaintext secrets.
